...
class SimpleViewPagerAdapter(var fm : FragmentManager) : BaseDelegateAdapter<SimpleViewPagerAdapter.ViewHolder, String>(){
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): ViewHolder {
        ...
        val params = LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ScreenUtil.getScreenHeight() - ScreenUtil.getStatusBarHeight())
